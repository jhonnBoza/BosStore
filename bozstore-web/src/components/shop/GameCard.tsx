...
export default function GameCard({ game }: { game: Game }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col border border-zinc-200 bg-white transition-colors duration-300 hover:border-red-400/50 dark:border-white/5 dark:bg-zinc-900 dark:hover:border-red-600/30"
    >
      {/* Cover */}
      <div className="relative aspect-[3/4] overflow-hidden bg-zinc-100 dark:bg-zinc-800">
        {game.cover_url ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-zinc-100 dark:bg-zinc-800">
            <span className="select-none font-podium text-6xl uppercase text-zinc-200 dark:text-white/5">
      ...
      {/* Info */}
      <div className="flex flex-1 flex-col gap-2 bg-white p-4 dark:bg-zinc-900">
        <h3 className="line-clamp-2 font-inter text-sm font-semibold uppercase leading-tight tracking-wide text-zinc-800 dark:text-white/90">
          {game.title}
        </h3>
        ...
        <div className="mt-auto flex items-center justify-between pt-3">
          <div className="flex flex-col">
            ...
            <span className="font-inter text-base font-bold text-zinc-900 dark:text-white">
              {formatPrice(price)}
            </span>
          </div>
